 ...
 */
public class SuccessfulPlayerCraftEvent extends Event implements Cancellable {
     ...
     */
    public SuccessfulPlayerCraftEvent(CraftItemEvent event, Player p) {
    ...
    /**
     * Setter for cancelled, cancels the associated craftItemEvent
